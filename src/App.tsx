    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative text-white py-20 overflow-hidden" style={{minHeight: '420px'}}>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-200 mb-6">Your trusted source for Illinois insurance news, laws, and resources</p>
          <p className="text-blue-300 text-lg mb-10 max-w-2xl mx-auto">We help Illinois residents navigate the challenges of harsh winters, flood risk in low-lying areas, and tornado belt exposure — so you can make informed decisions about your home, auto, and business coverage. No jargon, no pressure.</p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-200 text-xl mb-4">If you've read through the guide and want a second opinion on your current policy — or just want to see what else is available in Illinois — our local agents are happy to help. No pressure, no obligation.</p>
